...
def main():
      ...
      if numpages > max:
           exit(f'You have exceeded the maximum of scrapeable pages. Choose a number lower than {max}')
      else:
            start = time.time()
            ...
            print(f'for {len(immoscrap.data_set_df)} rows on {immoscrap.numpages + 1} scraped base urls') 
